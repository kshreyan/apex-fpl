...
def parse_bootstrap(payload: dict[str, Any], meta: dict[str, Any], snapshot_name: str) -> dict[str, list[dict[str, Any]]]:
    ...
    for el in payload.get("elements", []):
        ...
        player_stats.append({
            ...
            "defensive_contribution_per_90": el.get("defensive_contribution_per_90"),
            "clearances_blocks_interceptions": el.get("clearances_blocks_interceptions"),
            "recoveries": el.get("recoveries"), "tackles": el.get("tackles"),
